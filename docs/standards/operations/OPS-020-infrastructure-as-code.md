...
2. `OPS-020.2` — A manual change made directly on a production system to resolve an emergency MUST be backported into version-controlled configuration within 24 hours.
